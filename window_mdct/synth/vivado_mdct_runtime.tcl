...
# mdct_core is an integration block, not a package-pin top.  Out-of-context
# mode prevents its wide debug/result ports from being implemented as IOBs.
synth_design -mode out_of_context -top mdct_core -part $part_name \
