## 100 MHz standalone characterization target, aligned with the FFT core.
## The board overlay uses its own PS-generated clock (50 MHz by default).
## This file is NOT read by vivado_pynq_z2_bitstream.tcl.
